...
from codara.config import Settings, resolve_provider_model
from codara.core.models import Message, TurnResult, UagOptions
...
class InferenceService:
    ...
    def ensure_active_api_key(self, user_id: str, *, label: Optional[str] = None):
        from codara.core.security import generate_api_key
