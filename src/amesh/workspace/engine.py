...
class WorkspaceEngine:
    ...
    def ensure_git_repository(self) -> None:
        ...
        if not self._has_git_head():
            ...
            env = os.environ.copy()
            env.setdefault("GIT_AUTHOR_NAME", "Ameshe")
            env.setdefault("GIT_AUTHOR_EMAIL", "amesh@local")
    ...
    def commit(self, message: str, author_name: str = "Ameshe", author_email: str = "amesh@local") -> str:
        if not self.is_git_repo():
