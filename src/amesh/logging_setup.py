...
from amesh.telemetry import current_trace_context, serialize_log_record

_MANAGED_HANDLER_ATTR = "_amesh_managed"
_CONFIGURED_LOG_PATH: Optional[Path] = None
_APP_LOGGER_NAME = "amesh"
...
def configure_logging(current_settings: Optional[Settings] = None, *, force: bool = False) -> Path:
    ...
    app_logger.info("Ameshe logging initialized at %s", log_path)
    return log_path
